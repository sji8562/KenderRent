						...
						<form action="/user/findId" method=post onsubmit="return checkForm();">
							<div>
								<div class="row">
									...
									<input id="authCode" name="authCode"  class="form_input input_email input_ph" type="text" style="display: none"  placeholder="인증코드 6자리를 입력해주세요">
