				        ...
				        <li style="width:25%; float: left; margin-right: 50px">
				            <div class="item_cont">
				                <div class="item_photo_box">
				                    <a href="/product/detail/${goodsProduct.id }">
				                        <img src=${goodsProduct.picUrl } width="250" alt="${goodsProduct.name }" title="${goodsProduct.name }" class="middle">
				                    </a>
				                </div>
				                <!-- //item_photo_box -->
					                ...
					                <div class="item_info_cont">
					                    <div class="item_tit_box">
					                        <a href="/product/detail/${goodsProduct.id }">
					                            <strong class="item_name">${goodsProduct.name }</strong>
					                        </a>
					                    </div>
					                    <!-- //item_tit_box -->
					                    <div class="item_money_box">
					                        <strong class="item_price">
					                            <span style="">${goodsProduct.price }원 </span>
					                        </strong>
