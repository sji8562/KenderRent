						...
						<nav class="navbar">
							<ul class="navbar_menu">
								<li class="nav-item dropdown">
			                        <a href="/product/categories" class="nav-link dropdown-toggle">빅사이즈 장난감</a>
			                        <div class="dropdown-menu m-0">
			                            <a href="price.html" class="dropdown-item">모빌</a>
								...
								<li class="nav-item dropdown">
			                        ...
			                        <div class="dropdown-menu m-0">
			                            ...
			                            <a href="team.html" class="dropdown-item">12~24개월</a>
			                            <a href="testimonial.html" class="dropdown-item">24개월~</a>
			                        </div>
			                    </li>
								<li class="nav-item dropdown">
			                        <a href="/product/categories" class="nav-link dropdown-toggle">유아가전제품</a>
			                        <div class="dropdown-menu m-0">
			                            <a href="price.html" class="dropdown-item">살균기</a>
			                            <a href="feature.html" class="dropdown-item">기타</a>
			                        </div>
			                    </li>
								<li class="nav-item dropdown">
			                        <a href="/product/categories" class="nav-link dropdown-toggle">산모용품</a>
			                        <div class="dropdown-menu m-0">
			                            <a href="price.html" class="dropdown-item">유축기</a>
			                            <a href="feature.html" class="dropdown-item">마사지기</a>
			                        </div>
			                    </li>
			                    <li class="nav-item dropdown">
			                        <a href="/product/categories" class="nav-link dropdown-toggle" >책</a>
			                        <div class="dropdown-menu m-0">
			                            <a href="price.html" class="dropdown-item">촉감책</a>
			                            <a href="feature.html" class="dropdown-item">초점잭</a>
			                            <a href="feature.html" class="dropdown-item">그림책</a>
			                            <a href="feature.html" class="dropdown-item">동화책</a>
			                        </div>
			                    </li>
			                    <li class="nav-item dropdown">
			                        <a href="/customer/contact" class="nav-link dropdown-toggle" >고객센터</a>
			                        <div class="dropdown-menu m-0">
...
<!-- 										장바구니아이콘 -->
									...
									<c:otherwise>
										...
										<a class="size" href="/user/sign-up-page" style="color:black">회원가입</a>
			...
			<li class="menu_item"><a href="/">home</a></li>
				<li class="menu_item has-children">
					<c:choose>
						<c:when test="${sessionScope.principal != null }">
							<a href="#">
								${sessionScope.principal.userName }님 환영합니다
