        ...
        <form class="mng--login--input--form" action="/mng/sign-in" method="post">
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" id="username" name="username" placeholder="아이디를 입력하세요" required  oninput="this.value=this.value.replace(/[^a-zA-Z0-9]/g,'');">
                </div>
                <div class="form-group col-md-12">
                    <label for="password" class="mng--float--left">비밀번호</label> <%-- 영어, 숫자, 특수문자만 입력 가능하도록 처리 --%>
                    <input type="password" class="form-control" id="password" name="password" placeholder="비밀번호를 입력하세요" required oninput="this.value=this.value.replace(/[^a-zA-Z0-9~!@#$%^&*()_+|<>?:{}]/g,'');">
                </div>
            </div>
