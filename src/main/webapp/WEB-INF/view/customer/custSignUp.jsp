...
<div class="col-sm-8">
	...
	<div>
		<form action="/customer/custSignUp" method="post">
			...
			<div class="form-group">
				<label for="custNickname">닉네임</label> <input type="text"
					class="form-control" id="custNickname" name="custNickname">
			</div>
			<div class="form-group">
				<label for="custAddress">주소</label> <input type="text"
					class="inputTypeText" id="postcode" name="postcode">우편번호 <input
					type="text" class="inputTypeText" id="addr1" name="addr1">주소
				<input type="text" class="inputTypeText" id="addr2" name="addr2">상세주소
				<!-- 카카오 우편번호 서비스 기능 추가 -->

			</div>
			<div class="form-group">
				<label for="custPhNum">연락처</label> <select id="phNum1"
					name="phNum[]">
