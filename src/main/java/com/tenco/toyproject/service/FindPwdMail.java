...
@Service
public class FindPwdMail implements MailingService {
	...
	public MimeMessage createMessage(String to) throws MessagingException, UnsupportedEncodingException {
		...
		msgg += "<h1> 안녕하세요</h1>";
		msgg += "<h1> 우리 아이를 위한 현명한 소비 생활 킨더렌드 입니다.</h1>";
		msgg += "<br>";
		...
		message.setFrom(new InternetAddress("kinderlend@naver.com", "Kinderlend_Admin"));// 보내는 사람
